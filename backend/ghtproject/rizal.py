...
class Alamat(models.Model):
    id_alamat = models.IntegerField(db_column='ID_ALAMAT', primary_key=True)  # Field name made lowercase.
    id_pelanggan = models.IntegerField(db_column='ID_PELANGGAN')  # Field name made lowercase.
...
class Berita(models.Model):
    id_berita = models.IntegerField(db_column='ID_BERITA', primary_key=True)  # Field name made lowercase.
...
class Cart(models.Model):
    id_cart = models.IntegerField(db_column='ID_CART', primary_key=True)  # Field name made lowercase.
    id_pelanggan = models.IntegerField(db_column='ID_PELANGGAN')  # Field name made lowercase.
    id_alamat = models.IntegerField(db_column='ID_ALAMAT')  # Field name made lowercase.
...
class Kandungan(models.Model):
    id_kandungan = models.IntegerField(db_column='ID_KANDUNGAN', primary_key=True)  # Field name made lowercase.
...
class Kategori(models.Model):
    id_kategori = models.IntegerField(db_column='ID_KATEGORI', primary_key=True)  # Field name made lowercase.
...
class Komentar(models.Model):
    id_komentar = models.IntegerField(db_column='ID_KOMENTAR', primary_key=True)  # Field name made lowercase.
...
class Menu(models.Model):
    id_menu = models.IntegerField(db_column='ID_MENU', primary_key=True)  # Field name made lowercase.
    id_kategori = models.IntegerField(db_column='ID_KATEGORI')  # Field name made lowercase.
...
class Outlet(models.Model):
    id_outlet = models.IntegerField(db_column='ID_OUTLET', primary_key=True)  # Field name made lowercase.
...
class Outlethassevis(models.Model):
    id_servis = models.IntegerField(db_column='ID_SERVIS', primary_key=True)  # Field name made lowercase.
    id_outlet = models.IntegerField(db_column='ID_OUTLET')  # Field name made lowercase.
...
class Pelanggan(models.Model):
    id_pelanggan = models.IntegerField(db_column='ID_PELANGGAN', primary_key=True)  # Field name made lowercase.
...
class Pesanan(models.Model):
    id_menu = models.IntegerField(db_column='ID_MENU', primary_key=True)  # Field name made lowercase.
    id_cart = models.IntegerField(db_column='ID_CART')  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'pesanan'
        unique_together = (('id_menu', 'id_cart'), ('id_menu', 'id_cart'),)
